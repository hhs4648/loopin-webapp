...
/** Figma Export: 학습 로그인 (`플래시화면.svg`) — Apple / 카카오 / 구글 */
      ...
      <div className="relative aspect-[393/852] w-full max-w-[540px] self-center">
        ...
        */}
        ...
        {/* Google — x=20 y=757 w=353 h=58
            SVG에도 슬롯·글자가 있지만, 기기 safe-area에서 하단이 잘리거나
            빈 슬롯만 보이는 경우가 있어 React로 버튼을 다시 그린다. */}
        <button
          type="button"
          aria-label="Google로 시작하기"
          className="absolute left-[5.09%] top-[88.85%] z-20 flex h-[6.81%] w-[89.82%] cursor-pointer items-center justify-center gap-[10px] rounded-[14px] border border-[#E5E7EB] bg-white font-sans text-[16px] font-semibold text-[#26292E] shadow-[0_1px_0_rgba(0,0,0,0.04)]"
          onClick={() => void handleSocialLogin('google')}
        >
          <GoogleMark className="h-[24px] w-[24px] shrink-0" />
          Google로 시작하기
        </button>
